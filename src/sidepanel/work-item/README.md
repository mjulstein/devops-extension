[root](../../../README.md) / [src](../../README.md) / [sidepanel](../README.md) / work-item

# `src/sidepanel/work-item/`

This directory contains the Active item tab UI.
...
- `WorkItemPane.tsx` + `WorkItemCard.module.css` — active-item layout composition for status messaging, task creation/selection, and parent suggestion sections.
