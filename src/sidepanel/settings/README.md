...
`- `SettingsPane.tsx` + `SettingsCard.module.css` — renders the organization, project, assigned-to, and TODO states fields plus the Save settings and Reload extension actions.
